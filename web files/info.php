...
if ( isset( $_GET[ "username" ] ) )
{
	...
	else
	{
		...
		{
			echo "https://frezzyhook.xyz/forum/data/avatars/l/0/" . $user[ "user_id" ] . ".jpg";
		}
		else if ( isset( $_GET[ "profile" ] ) )
		{
			echo "https://frezzyhook.xyz/forum/members/" . $user[ "username" ] . "." . $user[ "user_id" ];
		}
		...
		else if ( isset( $_GET[ "expire" ] ) )
		{
		    ...
		    $db   = 'frezzyho_bec5ta'; //имя бд
		    $dbuser = 'frezzyho_bec5t'; //имя пользователя бд
		    $pass = 'fuckoff?'; //пароль бд
		    $charset = 'utf8';
