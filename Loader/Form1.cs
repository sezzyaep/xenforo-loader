...
namespace Loader
{
    ...
    {
        string adress = "http://frezzyhook.xyz/forum/"; // ur forum link
        string secret = "-HcjBXAEDW2-h3A_5rWjQEiwI9X9QocQ";
        string version = "1.65";
        bool hwid;
        string hwidstring;
        public Form1()
        ...
        {
            if (File.Exists(@"C:\fuckhook\loader\account.fuckhook"))
            {
                string[] empty = File.ReadAllLines(@"C:\fuckhook\loader\account.fuckhook");
                if (empty.Length == 0)
                {
                    return;
                }
                string password_decode = File.ReadLines(@"C:\fuckhook\loader\account.fuckhook").Skip(1).First();
                string login_decode = File.ReadLines(@"C:\fuckhook\loader\account.fuckhook").Skip(0).First();
            ...
            else
            {
                ...
                File.Create(@"C:\fuckhook\loader\account.fuckhook");
                Application.Restart();
            }
        }
                    ...
                    {
                        {
                            ...
                            {
                                StreamWriter file = new StreamWriter(@"C:\fuckhook\loader\account.fuckhook");
