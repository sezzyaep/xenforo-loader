...
namespace Loader
{
    ...
    {
        string adress = "https://frezzyhook.xyz/forum/"; // ur forum link
        public mainForm()
        {
            InitializeComponent();
            timer1.Start();
        ...
        {
            if (File.Exists(@"C:\fuckhook\loader\username.fuckhook"))
            {
                string[] empty = File.ReadAllLines(@"C:\fuckhook\loader\username.fuckhook");
                if (empty.Length == 0)
                {
                    return;
                }
            ...
            {
                Directory.CreateDirectory(@"C:\fuckhook\loader\");
                File.Create(@"C:\fuckhook\loader\username.fuckhook");
                Application.Restart();
            }
        }
       ...
       private void usernamefile2()
        {
            if (File.Exists(@"C:\fuckhook\loader\username.fuckhook"))
            {
                StreamWriter file = new StreamWriter(@"C:\fuckhook\loader\username.fuckhook");
                string line1 = File.ReadLines("C:\\fuckhook\\loader\\account.fuckhook").First();
        ...
        private void inject()
        {
            String strDLLName = @"C:\\fuckhook\\cheat.dll";
        ...
        async void bunifuButton1_Click(object sender, EventArgs e)
        {
            ...
            System.IO.Directory.CreateDirectory("C:\\FuckHook");
            wc.Headers.Add("User-Agent", "your user agent here");
            wc.DownloadFileAsync(new Uri($"{adress}/sex.dll"), @"C:\fuckhook\cheat.dll");
